...
namespace strategy.DbModels
{
    public partial class STRATSIGNER170424Context : DbContext
    {
        ...
        public STRATSIGNER170424Context(DbContextOptions options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<ActionTodoDepartmentTemp> ActionTodoDepartmentTemps { get; set; }
        ...
        public virtual DbSet<LinkSharepoint> LinkSharepoints { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=EFACH\\SQL2014;Initial Catalog=STRATSIGNER170424;User ID=sa;Password=Abc123;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ActionTodoDepartmentTemp>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("ActionTodoDepartmentTemp");
            ...
            modelBuilder.Entity<Category>(entity =>
            {
                ...
                entity.Property(e => e.Extension3).HasComment("RolloutView (Action category & Goal category)");
            ...
            modelBuilder.Entity<LinkSharepoint>(entity =>
            {
                entity.ToTable("LinkSharepoint");
                ...
                entity.Property(e => e.FilterSnapshot).HasComment("Save Filter text to show tooltip");
